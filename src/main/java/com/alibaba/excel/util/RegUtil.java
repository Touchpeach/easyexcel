...
//        System.out.println("判断中文字符: "+RegexUtil.isChineseChar("中国！"));
        System.out.println("匹配汉字: " + RegUtil.isChinese("中国！"));
...
//        System.out.println("匹配密码: "+RegexUtil.isUrl("http://baidu.com"));
        System.out.println("验证字符: " + RegUtil.stringCheck("中文aabc001_-"));
...
//        System.out.println(NumberUtils.toInt("-0000000002"));
    ...
    public final static boolean isMobile(String text) {
        ...
        return match(text, "^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1})|(14[0-9]{1})|(17[0-9]{1}))+\\d{8})$");
    }
    ...
    public static boolean isNotNull(JSONObject jo) {
        return !isNull(jo);
    }
    ...
    public static boolean isNotNull(JSONArray ja) {
        return !isNull(ja);
    }
